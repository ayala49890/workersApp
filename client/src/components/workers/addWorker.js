...
// //     roles: [{ roleId: 0, entryDate: "" }], // Initial role
// //     status: true,
// //   });
...
//     startWorkingDate: "",
//     gender: GenderEnum.Male,
//     roles: [{ roleId: "", entryDate: "" }], // Initial role
//     status: true,
//   });
//   const [roleIsManager, setRoleIsManager] = useState([false]); // Initial role is not manager
//   const [addRoleEnabled, setAddRoleEnabled] = useState(false); // Enable add role button
...
//   const handleAddRole = () => {
//     const updatedRoles = [{ roleId: "", entryDate: "" }, ...formData.roles];
//     // const updatedRoles = [{ roleId: 0, entryDate: new Date() }, ...formData.roles];
//     setFormData({ ...formData, roles: updatedRoles });
//     setRoleIsManager([false, ...roleIsManager]);
//   };
...
const AddWorker = () => {
  ...
  const handleInputChange = (e) => {
    const { name, value } = e.target;
    setFormData({ ...formData, [name]: value });
    // Update entryDate for all roles when dateOfBirth or startWorkingDate changes
    if (name === "dateOfBirth" || name === "startWorkingDate") {
